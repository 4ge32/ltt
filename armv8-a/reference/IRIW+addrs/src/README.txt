...
RUNNING ONE TEST
  Tests are .exe files, for instance IRIW+addrs.exe, run it by './IRIW+addrs.exe'
...
RUNNING OPTIONS
  ...
  For more options see for instance './IRIW+addrs.exe -help' and litmus documentation
