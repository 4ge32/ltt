...
RUNNING ONE TEST
  Tests are .exe files, for instance mp+rel+acq.exe, run it by './mp+rel+acq.exe'
...
RUNNING OPTIONS
  ...
  For more options see for instance './mp+rel+acq.exe -help' and litmus documentation
