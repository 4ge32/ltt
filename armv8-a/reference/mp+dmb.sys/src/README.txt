...
RUNNING ONE TEST
  Tests are .exe files, for instance mp+dmb.sys.exe, run it by './mp+dmb.sys.exe'
...
RUNNING OPTIONS
  ...
  For more options see for instance './mp+dmb.sys.exe -help' and litmus documentation
